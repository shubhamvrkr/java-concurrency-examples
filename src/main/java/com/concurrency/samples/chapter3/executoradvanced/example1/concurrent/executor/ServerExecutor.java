 ...
 * This will execute the commands given by Request Task after marshalling of client request
 *
 */
public class ServerExecutor extends ThreadPoolExecutor {
	...
	public ServerExecutor() {
		//uses default blocking queue as thread pool with custom rejection handler
        //provide custom blocking queue for controlling the order of execution of the task
        //can also provide custom thread factory to create threads that will execute the task
